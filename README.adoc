...
----
TIP: Data模块没有PersisterFactory的具体实现，需参考link:../weforward-data-mongodb/README.adoc[Weforward Data Mongodb]实现
...
条件搜索理论上支持持久类的所有属性，但是直接按这些属性条件搜索可以效率会比较低，所以我们需要对经常用来查询的属性建议索引 
